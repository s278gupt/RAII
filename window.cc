...
Xwindow::Xwindow(int width, int height): width{width}, height{height} {
	...
	//Make sure cornflowerblue is last? for some reason??
	char color_vals[10][20] = {"white", "black", "webgreen", "palevioletred",
		"gainsboro", "green", "red", "ivory", "purple", "cornflowerblue"};
...
void Xwindow::drawBigString(int x, int y, string msg, int colour) {
  ...
  ostringstream name;
  //name << "-schumacher-clean-medium-r-normal--16-160-75-75-c-80-iso646.1991-irv";
  name << "-misc-fixed-medium-r-normal--18-120-100-100-c-90-iso8859-1";
